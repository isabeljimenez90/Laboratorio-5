...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-05-2025 a las 05:55:59
...
(11, 'Mario Vargas Llosa', 'Peruana', '1936-03-28');
...
INSERT INTO `libros` (`ID_Libros`, `Titulo`, `ID_Autor`, `ID_Categoria`, `AÑO_Publicacion`, `Disponible`) VALUES
...
(9, '1984', 3, 2, 1949, 1),
(10, 'La Casa de los Espíritus', 4, 1, 1982, 1),
(11, 'La Ciudad y los Perros', 5, 1, 1963, 1);
...
INSERT INTO `prestamos` (`ID_Prestamo`, `ID_Usuario`, `ID_Libros`, `Fecha_Prestamo`, `Fecha_Devolucion`) VALUES
...
INSERT INTO `usuarios` (`ID_Usuario`, `Nombre`, `Direccion`, `Telefono`, `Correo`) VALUES
(1, 'Carlos Martínez', 'Calle Luna, 123', '123456789', NULL),
(2, 'Lucía Fernández', 'Avenida Sol, 456', '987654321', NULL),
(3, 'Carlos Martínez', 'Calle Luna, 123', '123456789', NULL),
(4, 'Lucía Fernández', 'Avenida Sol, 456', '987654321', NULL),
(5, 'Marina Garcia', 'Avenida Carlos, 456', '987654321', NULL),
(9, 'Carlos Martínez', 'Calle Luna, 123', '123456789', 'carlos.martinez@email.com'),
(10, 'Lucía Fernández', 'Avenida Sol, 456', '987654321', 'lucia.fernandez@email.com'),
(11, 'Marina Garcia', 'Avenida Carlos, 456', '987654321', 'Mariana.Garcia@email.com');
...
ALTER TABLE `prestamos`
  ...
  ADD CONSTRAINT `prestamos_ibfk_2` FOREIGN KEY (`ID_Libros`) REFERENCES `libros` (`ID_Libros`);
COMMIT;
